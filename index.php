...
echo "$Green
	   ...
	   / __)(  _ \(  _  )(_  _)(_  _)( ___)( \/ )
	   \__ \ )___/ )(_)(   )(   _)(_  )__)  \  / 
	   (___/(__)  (_____) (__) (____)(__)   (__) \n" . "$White               fathur | nts-7.net\n\n\n";

echo "$Green Select the menu below";
echo "\n$White ╰┈➤ 1. Auto Daftar Akun and get Cookie Browser ";
echo "\n$White ╰┈➤ 2. Daftar and get Bearer Authorization app ";
echo "\n$White ╰┈➤ 3. Daftar Dan Klaim Spotify 3 Bulan Premium Samsung Galaxy Series (Beta) ";
echo "\n$Yellow ╰┈➤ Pilih : ";
$hai = trim(fgets(STDIN));
echo "$Grey ╰┈➤ Pilihanmu! $hai";


reg:
echo "\n\n";
echo "$Yellow Trying to register on spotify use random email ";
$email = randUser() . "@jing.me";
$pass = "@maniak123";
...
echo "\n$Green ╰┈➤ Berhasil Klaim Offer Samsung Galaxy series :*";
sleep(1);
echo "\n$Yellow ╰┈➤ Pergi ke browser dan login untuk aktifasi!";
sleep(2);
